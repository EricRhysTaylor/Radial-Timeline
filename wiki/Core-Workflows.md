...
*   Use [Gossamer Mode](Gossamer-Mode) for beat-level scoring, and [Inquiry](Inquiry) for corpus-level analysis.
...
*   Use [Publishing](Publishing) for template selection, Modern Classic setup, chapter handling, and publishing-specific options.
*   Use [Command Palette](Commands) if you only need the command reference.
