...
<div style="text-align: center; margin: 20px 0;">
  <img src="images/Manage subplots.png" alt="Manage subplots panel" style="width: 500px; max-width: 100%; border-radius: 8px;" />
  <div style="font-size: 0.85em; margin-top: 8px; color: #666;">Manage subplots — bulk rename or remove subplot labels</div>
</div>
