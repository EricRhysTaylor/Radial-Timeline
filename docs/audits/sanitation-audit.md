...
| `NOTE` | stale-comment | 304 |
| `TODO` | stale-comment | 77 |
| `DEPRECATED` | stale-comment | 59 |
| `refreshTimelineIfNeeded` | drift-term | 32 |
| `mergeTemplates` | drift-term | 21 |
...
| `src/settings/sections/BeatPropertiesSection.ts` | 104 |
...
- Lane C: AI + export pipeline (880 hits). Consolidate merge-helper naming and align comments with canonical helpers.
...
| `src/ai/prompts/gossamer.ts` | 47 | `"note": "Opening establishes world effectively"` |
| `src/ai/prompts/gossamer.ts` | 52 | `"note": "Strong reversal creates new stakes"` |
| `src/ai/prompts/gossamer.ts` | 63 | `- "note": one concise sentence of guidance for this beat` |
...
| File | Line | Matched line |
| --- | --- | --- |
| `src/api/anthropicApi.ts` | 6 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/geminiApi.ts` | 6 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/legacyAccessGuard.ts` | 1 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/localAiApi.ts` | 5 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/openaiApi.ts` | 6 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/providerCapabilities.ts` | 1 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/providerErrors.ts` | 1 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/providerRouter.ts` | 4 | `// TODO: DEPRECATED — migrate to aiClient` |
| `src/api/requestPayload.ts` | 1 | `// TODO: DEPRECATED — migrate to aiClient` |
...
| `src/modals/GossamerProcessingModal.ts` | 153 | `// TODO: Update this check to be provider-agnostic` |
...
| `src/main.ts` | 206 | `this.refreshTimelineIfNeeded(null);` |
| `src/main.ts` | 213 | `this.refreshTimelineIfNeeded(null);` |
| `src/main.ts` | 341 | `this.refreshTimelineIfNeeded(null);` |
| `src/main.ts` | 855 | `// Settings UI calls this instead of refreshTimelineIfNeeded(null) so` |
| `src/main.ts` | 873 | `this.refreshTimelineIfNeeded(null, 100);` |
| `src/main.ts` | 877 | `refreshTimelineIfNeeded(file: TAbstractFile \| null \| undefined, delayMs?: number) {` |
| `src/main.ts` | 881 | `this.timelineService.refreshTimelineIfNeeded(file, effectiveDelay);` |
...
| File | Line | Matched line |
| --- | --- | --- |
| `src/settings/sections/BeatPropertiesSection.ts` | 1638 | `let mergeTemplatesButton: ButtonComponent \| undefined;` |
| `src/settings/sections/BeatPropertiesSection.ts` | 1698 | `mergeTemplatesButton = button;` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5365 | `if (mergeTemplatesButton) {` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5366 | `mergeTemplatesButton.setDisabled(true);` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5367 | `mergeTemplatesButton.buttonEl.addClass('ert-hidden');` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5396 | `if (mergeTemplatesButton) {` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5397 | `mergeTemplatesButton.setDisabled(true);` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5398 | `mergeTemplatesButton.buttonEl.addClass('ert-hidden');` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5528 | `if (mergeTemplatesButton && isCustom && (hasMisaligned \|\| hasMissingModel \|\| hasLegacyToRepair)) {` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5529 | `mergeTemplatesButton.buttonEl.removeClass('ert-hidden');` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5530 | `mergeTemplatesButton.setDisabled(false);` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5532 | `mergeTemplatesButton.setButtonText(`Repair ${repairCount} beat note${repairCount > 1 ? 's' : ''}`);` |
| `src/settings/sections/BeatPropertiesSection.ts` | 5537 | `mergeTemplatesButton.setTooltip(`Update Act, Beat Model, and Beat Id for ${repairBits.join(' and ')} beat note${repairCount > 1 ? 's' : ''}. Prefix numbers are not changed.`);` |
