...
export function createInquiryDesktopShell(args: {
    ...
    engineTimerIcon.setAttribute('y', '14');
    engineTimerIcon.setAttribute('width', '28');
    engineTimerIcon.setAttribute('height', '28');
    ...
    engineTimerLabel.setAttribute('x', String(engineBadgeX + iconSize + 48));
