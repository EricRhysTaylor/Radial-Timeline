    ...
    normalizeModelIds(): void {
        ...
        const normalize = (prov: 'anthropic' | 'openai' | 'gemini', id: string | undefined): string => {
            ...
            if (prov === 'anthropic') {
                ...
                if (id === 'claude-4-sonnet' || id === 'claude-sonnet-4-1' || id === 'claude-3-7-sonnet-20250219' || id === 'claude-sonnet-4-0' || id === 'claude-sonnet-4-1@20250805' || id === 'claude-sonnet-4-20250514') return 'claude-sonnet-4-6';
                return id;
            }
            if (prov === 'openai') {
