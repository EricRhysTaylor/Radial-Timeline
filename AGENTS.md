...
Do NOT use git worktrees. Do NOT work from `~/.Codex-worktrees/`. If you find yourself in a worktree path, switch to the main repo path above before making any changes.
